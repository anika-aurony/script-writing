                    ...
                    <form onSubmit={handleAddScript}>
                        <div >
                            ...
                            <div className="form-control border-white border-none  w-full mt-4 d-flex flex-column">
                                ...
                                <input type="text" placeholder="Untitled Screenplay" className="input p-2 input-bordered rounded-pill w-full max-w-xs" name="title" required />
                            </div>
                            <div className="form-control border-white border-none p-2 w-full mt-2 d-flex flex-column">
                                <label className="label">
                            ...
                            <div className="form-control border-white border-none w-full mt-2 d-flex flex-column">
                                ...
                                <select className="input input-bordered rounded-pill w-full p-2 max-w-xs" name="genre" required>
